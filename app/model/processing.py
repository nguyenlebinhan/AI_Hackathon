...
class ProcessingStep(str, Enum):
    ...
    DETECTING_PAGE_BOUNDARIES = "DETECTING_PAGE_BOUNDARIES"
...
class ProcessingJob(TimestampMixin, Base):
    ...
    __table_args__ = (
        ...
        UniqueConstraint("document_id", "job_type", name="uq_processing_job_document_type"),
    )

    id: Mapped[str] = mapped_column(
        String(40), primary_key=True, default=prefixed_uuid("job")
    )
    ...
    current_step: Mapped[ProcessingStep] = mapped_column(
        ...
        nullable=False,
        default=ProcessingStep.WAITING_FOR_PROCESSING,
    )
